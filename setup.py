...
setup(
    ...
    entry_points={
        ...
        'datalad.metadata.extractors': [
            ...
            'annex=datalad_metalad.extractors.legacy.annex:MetadataExtractor',
            'audio=datalad_metalad.extractors.legacy.audio:MetadataExtractor',
            'datacite=datalad_metalad.extractors.legacy.datacite:MetadataExtractor',
            'datalad_core=datalad_metalad.extractors.legacy.datalad_core:MetadataExtractor',
            'datalad_rfc822=datalad_metalad.extractors.legacy.datalad_rfc822:MetadataExtractor',
            'exif=datalad_metalad.extractors.legacy.exif:MetadataExtractor',
            'frictionless_datapackage=datalad_metalad.extractors.legacy.frictionless_datapackage:MetadataExtractor',
            'image=datalad_metalad.extractors.legacy.image:MetadataExtractor',
            'xmp=datalad_metalad.extractors.legacy.xmp:MetadataExtractor',
        ],
